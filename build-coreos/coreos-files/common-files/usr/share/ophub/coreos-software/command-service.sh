...
software_path="/usr/share/ophub/coreos-software"
...
EOF
        ...
        sudo systemctl disable coreos-zram-config.service
        sudo systemctl disable coreos-ramlog.service
        ...
        echo -e "${SUCCESS} PVE installation is successful, please [ reboot ] CoreOS."
        ;;
    update) software_update ;;
